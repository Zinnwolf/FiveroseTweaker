return function(api)
	local run = function(func)
		...
		if not ok then
			...
			warn('[fiverosetweaker/frontlines] '..tostring(err))
		end
	...
	required(function()
		...
		repeat
			...
			if frontlines.ShootFunction and frontlines.Main then
				break
			end
		...
		if vape.Loaded == nil or not (frontlines.ShootFunction and frontlines.Main) then
			return
		end
	...
	if vape.Loaded == nil or not (frontlines.ShootFunction and frontlines.Main) then
		notif('Frontlines', 'Actor state was not available; game modules were skipped', 8, 'warning')
		error('Frontlines actor state was not available', 0)
	end
	...
	-- source: src/games/frontlines/5938036553 - game/Blatant/GrenadeTP.lua
	run(function()
		local GrenadeTP
		local Range
	...
	-- source: src/games/frontlines/5938036553 - game/Blatant/GunModifications.lua
	run(function()
	...
	-- source: src/games/frontlines/5938036553 - game/Blatant/Killaura.lua
	run(function()
		local Killaura
		local Targets
		local SwingRange
	...
	-- source: src/games/frontlines/5938036553 - game/Blatant/Phase.lua
	run(function()
		local Phase
	...
	-- source: src/games/frontlines/5938036553 - game/Blatant/SpinBot.lua
	run(function()
		local SpinBot
		local Speed
		local Yaw
	...
	-- source: src/games/frontlines/5938036553 - game/Combat/AimAssist.lua
	run(function()
		local AimAssist
		local FOV
		local Speed
	...
	-- source: src/games/frontlines/5938036553 - game/Combat/SilentAim.lua
	run(function()
		local SilentAim
		local Target
		local Mode
	...
	-- source: src/games/frontlines/5938036553 - game/Combat/Sprint.lua
	run(function()
		local Sprint
	...
	-- source: src/games/frontlines/5938036553 - game/Legit/BulletTracers.lua
	run(function()
		local BulletTracers
		local Material
		local Color
	...
	-- source: src/games/frontlines/5938036553 - game/Render/GrenadeESP.lua
	run(function()
		local GrenadeESP
		local Background
		local Color = {}
	...
	-- source: src/games/frontlines/5938036553 - game/Render/NoHurtCam.lua
	run(function()
		local NoHurtCam
	...
	-- source: src/games/frontlines/5938036553 - game/Render/ThirdPerson.lua
	run(function()
		local ThirdPerson
		local Distance
		local hook = false
	...
	-- source: src/games/frontlines/5938036553 - game/Utility/AutoRespawn.lua
	run(function()
		local AutoRespawn
	...
	-- source: src/games/frontlines/5938036553 - game/Utility/ChatSpammer.lua
	run(function()
		local ChatSpammer
		local Lines
		local Mode
	...
	-- source: src/games/frontlines/5938036553 - game/Utility/PickupRange.lua
	run(function()
		local PickupRange
		local Range
