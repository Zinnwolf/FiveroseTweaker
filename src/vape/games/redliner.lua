return function(api)
	...
	-- source: src/games/redliner/115875349872417 - game/Blatant/ClashSpoofer.lua
	run(function()
		local ClashSpoofer
		local Spoof
		local Add
	...
	-- source: src/games/redliner/115875349872417 - game/Blatant/LongJump.lua
	run(function()
		local Mode
		local Value
		local AutoDisable
	...
	-- source: src/games/redliner/115875349872417 - game/Blatant/Speed.lua
	run(function()
		local Speed
		local Value
		local AutoJump
	...
	-- source: src/games/redliner/115875349872417 - game/Blatant/TargetStrafe.lua
	run(function()
		local TargetStrafe
		local Targets
		local SearchRange
	...
	-- source: src/games/redliner/115875349872417 - game/Utility/AutoLeave.lua
	run(function()
		local AutoLeave
		local Delay
	...
	-- source: src/games/redliner/115875349872417 - game/World/Gravity.lua
	run(function()
		local Gravity
		local Value
