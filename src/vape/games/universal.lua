return function(api)
	local getcustomasset = getcustomasset or api.vape.Libraries.getcustomasset
	...
	local run = function(func)
		...
		if not ok then
			warn('[fiverosetweaker/universal] '..tostring(err))
		end
	end
	...
	local function canClick()
		...
		return (not (rawget(api.lib, 'Toggled') == true)) and (not inputService:GetFocusedTextBox())
	end
	...
	local hash = api.vapelibs.hash
	local prediction = api.vapelibs.prediction
	entitylib = api.vapelibs.entity
	local whitelist = {
		alreadychecked = {},
		customtags = {},
		tagcallback = {},
	...
	run(function()
		...
		function whitelist:process() return false end
	...
	-- source: src/games/universal - base/Blatant/AntiFall.lua
	run(function()
		local AntiFall
		local Method
		local Mode
	...
	-- source: src/games/universal - base/Blatant/Desync.lua
	run(function()
		local Desync
		local hook
	...
	-- source: src/games/universal - base/Blatant/Fly.lua
	run(function()
		local Fly
		local LongJump
		run(function()
	...
	-- source: src/games/universal - base/Blatant/HighJump.lua
	run(function()
		local HighJump
		local Mode
		local Value
	...
	-- source: src/games/universal - base/Blatant/HitBoxes.lua
	run(function()
		local HitBoxes
		local Targets
		local TargetPart
	...
	-- source: src/games/universal - base/Blatant/Invisible.lua
	run(function()
		local Invisible
		local oldcf
		local animtrack
	...
	-- source: src/games/universal - base/Blatant/Jesus.lua
	run(function()
		local Jesus
	...
	-- source: src/games/universal - base/Blatant/Killaura.lua
	run(function()
		local Killaura
		local Targets
		local CPS
	...
	-- source: src/games/universal - base/Blatant/LongJump.lua
	run(function()
		local Mode
		local Value
		local AutoDisable
	...
	-- source: src/games/universal - base/Blatant/MouseTP.lua
	run(function()
		local MouseTP
		local Mode
		local MovementMode
	...
	-- source: src/games/universal - base/Blatant/Phase.lua
	run(function()
		local Mode
	...
	-- source: src/games/universal - base/Blatant/Speed.lua
	run(function()
		local Speed
		local Mode
		local Options
	...
	-- source: src/games/universal - base/Blatant/Spider.lua
	run(function()
		local Mode
		local Value
		local State
	...
	-- source: src/games/universal - base/Blatant/SpinBot.lua
	run(function()
		local SpinBot
		local Mode
		local XToggle
	...
	-- source: src/games/universal - base/Blatant/Swim.lua
	run(function()
		local Swim
	...
	-- source: src/games/universal - base/Blatant/TargetStrafe.lua
	run(function()
		local TargetStrafe
		local Targets
		local SearchRange
	...
	-- source: src/games/universal - base/Blatant/Timer.lua
	run(function()
		local Timer
		local Value
	...
	-- source: src/games/universal - base/Combat/AimAssist.lua
	run(function()
		local AimAssist
		local Targets
		local Part
			...
			Function = function(callback)
				...
				if callback then
					...
					AimAssist:Clean(runService.RenderStepped:Connect(function(dt)
						...
						if rightClicked and not (rawget(api.lib, 'Toggled') == true) then
	...
	-- source: src/games/universal - base/Combat/AutoClicker.lua
	run(function()
		local AutoClicker
		local Mode
		local CPS
					...
					repeat
						if Mode.Value == 'Tool' then
							...
							if mouse1click and (isrbxactive or iswindowactive)() then
								if not (rawget(api.lib, 'Toggled') == true) then
	...
	-- source: src/games/universal - base/Combat/Reach.lua
	run(function()
		local Reach
		local Targets
		local Mode
	...
	-- source: src/games/universal - base/Combat/SilentAim.lua
	run(function()
		local mouseClicked
		run(function()
			local SilentAim
	...
	-- source: src/games/universal - base/Combat/TriggerBot.lua
	run(function()
		local TriggerBot
		local Targets
		local ShootDelay
	...
	-- source: src/games/universal - base/Legit/Atmosphere.lua
	run(function()
		local Atmosphere
		local Toggles = {}
	...
	-- source: src/games/universal - base/Legit/Breadcrumbs.lua
	run(function()
		local Breadcrumbs
		local Texture
		local Lifetime
	...
	-- source: src/games/universal - base/Legit/Cape.lua
	run(function()
		local Cape
		local Texture
		local part, motor
	...
	-- source: src/games/universal - base/Legit/ChinaHat.lua
	run(function()
		local ChinaHat
		local Material
		local Color
	...
	-- source: src/games/universal - base/Legit/Clock.lua
	run(function()
		local Clock
	...
	-- source: src/games/universal - base/Legit/Disguise.lua
	run(function()
		local Disguise
		local Mode
		local IDBox
	...
	-- source: src/games/universal - base/Legit/FOV.lua
	run(function()
		local FOV
		local Value
		local oldfov
	...
	-- source: src/games/universal - base/Legit/FPS.lua
	run(function()
		--[[
	...
	-- source: src/games/universal - base/Legit/Keystrokes.lua
	run(function()
		local Keystrokes
		local Style
		local Color
	...
	-- source: src/games/universal - base/Legit/Memory.lua
	run(function()
		local Memory
		local label
	...
	-- source: src/games/universal - base/Legit/Ping.lua
	run(function()
		local Ping
		local label
	...
	-- source: src/games/universal - base/Legit/SongBeats.lua
	run(function()
		local SongBeats
		local List
		local FOV
	...
	-- source: src/games/universal - base/Legit/Speedmeter.lua
	run(function()
		local Speedmeter
		local label
	...
	-- source: src/games/universal - base/Legit/TimeChanger.lua
	run(function()
		local TimeChanger
		local Value
		local old
	...
	-- source: src/games/universal - base/Minigames/MurderMystery.lua
	run(function()
		local MurderMystery
	...
	-- source: src/games/universal - base/Render/Arrows.lua
	run(function()
		local Arrows
		local Targets
		local Color
	...
	-- source: src/games/universal - base/Render/Chams.lua
	run(function()
		local Chams
		local Targets
		local Mode
	...
	-- source: src/games/universal - base/Render/ESP.lua
	run(function()
		local ESP
		local Targets
		local Color
	...
	-- source: src/games/universal - base/Render/Fullbright.lua
	run(function()
		local Fullbright
		local Mode
		local oldsettings = {}
	...
	-- source: src/games/universal - base/Render/GamingChair.lua
	run(function()
	...
	-- source: src/games/universal - base/Render/Health.lua
	run(function()
		local Health
	...
	-- source: src/games/universal - base/Render/NameTags.lua
	run(function()
		local NameTags
		local Targets
		local Color
	...
	-- source: src/games/universal - base/Render/PlayerModel.lua
	run(function()
		local PlayerModel
		local Scale
		local Local
	...
	-- source: src/games/universal - base/Render/Radar.lua
	run(function()
		local Radar
		local Targets
		local DotStyle
	...
	-- source: src/games/universal - base/Render/Search.lua
	run(function()
		local Search
		local List
		local Color
	...
	-- source: src/games/universal - base/Render/SessionInfo.lua
	run(function()
		local SessionInfo
		local FontOption
		local Hide
	...
	-- source: src/games/universal - base/Render/Tracers.lua
	run(function()
		local Tracers
		local Targets
		local Color
	...
	-- source: src/games/universal - base/Render/Waypoints.lua
	run(function()
		local Waypoints
		local FontOption
		local List
	...
	-- source: src/games/universal - base/Utility/AnimationPlayer.lua
	run(function()
	...
	-- source: src/games/universal - base/Utility/AntiRagdoll.lua
	run(function()
		local AntiRagdoll
	...
	-- source: src/games/universal - base/Utility/AutoRejoin.lua
	run(function()
		local AutoRejoin
		local Sort
	...
	-- source: src/games/universal - base/Utility/Blink.lua
	run(function()
		local Blink
		local Type
		local AutoSend
	...
	-- source: src/games/universal - base/Utility/ChatSpammer.lua
	run(function()
		local ChatSpammer
		local Lines
		local Mode
	...
	-- source: src/games/universal - base/Utility/Disabler.lua
	run(function()
		local Disabler
	...
	-- source: src/games/universal - base/Utility/Panic.lua
	run(function()
	...
	-- source: src/games/universal - base/Utility/Rejoin.lua
	run(function()
		local Rejoin
	...
	-- source: src/games/universal - base/Utility/ServerHop.lua
	run(function()
		local ServerHop
		local Sort
	...
	-- source: src/games/universal - base/Utility/StaffDetector.lua
	run(function()
		local StaffDetector
		local Mode
		local Profile
	...
	-- source: src/games/universal - base/Utility/StateSpoofer.lua
	run(function()
		local StateSpoofer
		local State
		local hook
	...
	-- source: src/games/universal - base/World/Anti-AFK.lua
	run(function()
		local connections = {}
	...
	-- source: src/games/universal - base/World/Freecam.lua
	run(function()
		local Freecam
		local Value
	...
	-- source: src/games/universal - base/World/Gravity.lua
	run(function()
		local Gravity
		local Mode
		local Value
	...
	-- source: src/games/universal - base/World/Parkour.lua
	run(function()
		local Parkour
	...
	-- source: src/games/universal - base/World/SafeWalk.lua
	run(function()
		local rayCheck = RaycastParams.new()
		rayCheck.RespectCanCollide = true
		local module, old
	...
	-- source: src/games/universal - base/World/Xray.lua
	run(function()
		local Xray
		local List
		local modified = {}
