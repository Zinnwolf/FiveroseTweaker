return function(api)
	local run = function(func)
		...
		if not ok then
			...
			warn('[fiverosetweaker/prison] '..tostring(err))
		end
	...
	required(function()
		...
		if not (pl.Bullet and pl.SwitchTable) then
			...
			repeat
				getShootFunction()
				task.wait()
			until pl.Bullet and pl.SwitchTable or vape.Loaded == nil or os.clock() >= timeout
		...
		for _, name in ipairs({'GunTracers', 'Shoot', 'Reload', 'Bullet', 'PlaySound', 'Equip', 'SwitchUpdate', 'SwitchTable'}) do
			if pl[name] == nil then
				error('Prison Life bootstrap missing '..name, 0)
			end
		end
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AntiInvisible.lua
	run(function()
		local AntiInvisible
		local threads = {}
		local whitelist = {
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AntiKillPlane.lua
	run(function()
		local AntiKillPlane
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AntiRiotShield.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AntiTaze.lua
	run(function()
		local AntiTaze
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AutoArrest.lua
	run(function()
		local AutoArrest
		local Range
		local HandCheck
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AutoReset.lua
	run(function()
		local AutoReset
	...
	-- source: src/games/prison life/155615604 - main/Blatant/AutoTaser.lua
	run(function()
		local AutoTaser
		local Range
		local VelocityCheck
	...
	-- source: src/games/prison life/155615604 - main/Blatant/FenceGodmode.lua
	run(function()
		local FenceGodmode
	...
	-- source: src/games/prison life/155615604 - main/Blatant/GunModifications.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Blatant/KickAll.lua
	run(function()
		local KickAll
	...
	-- source: src/games/prison life/155615604 - main/Blatant/Killaura.lua
	run(function()
		local Killaura
		local Targets
		local AttackRange
	...
	-- source: src/games/prison life/155615604 - main/Blatant/NoJumpCooldown.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Blatant/VehicleFly.lua
	run(function()
		local VehicleFly
		local Mode
		local Speed
	...
	-- source: src/games/prison life/155615604 - main/Blatant/VehicleSpeed.lua
	run(function()
		local VehicleSpeed
		local Speed
		local old
	...
	-- source: src/games/prison life/155615604 - main/Blatant/VehicleWallbang.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Combat/SilentAim.lua
	run(function()
		local mouseClicked
		run(function()
			local SilentAim
	...
	-- source: src/games/prison life/155615604 - main/Inventory/AutoArmor.lua
	run(function()
		local AutoArmor
		local pickups = {}
	...
	-- source: src/games/prison life/155615604 - main/Inventory/AutoHeal.lua
	run(function()
		local AutoHeal
		local healItems = {
			Breakfast = true,
	...
	-- source: src/games/prison life/155615604 - main/Inventory/AutoHotbar.lua
	run(function()
		local AutoHotbar
		local SortList = {}
	...
	-- source: src/games/prison life/155615604 - main/Inventory/AutoPickup.lua
	run(function()
		local AutoPickup
		local Lists = {}
		local items = {}
	...
	-- source: src/games/prison life/155615604 - main/Legit/BulletTracers.lua
	run(function()
		local BulletTracers
		local Material
		local Color
	...
	-- source: src/games/prison life/155615604 - main/Legit/Crosshair.lua
	run(function()
		local Crosshair
		local Image
		local old
	...
	-- source: src/games/prison life/155615604 - main/Legit/DamageIndicator.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Legit/HitSound.lua
	run(function()
		local HitSound
		local Value
		local Volume
	...
	-- source: src/games/prison life/155615604 - main/Legit/KillSound.lua
	run(function()
		local KillSound
		local Value
		local Volume
	...
	-- source: src/games/prison life/155615604 - main/Legit/Viewmodel.lua
	run(function()
		local Viewmodel
		local Depth
		local Horizontal
	...
	-- source: src/games/prison life/155615604 - main/Render/C4ESP.lua
	run(function()
		local C4ESP
		local FillColor
		local OutlineColor
	...
	-- source: src/games/prison life/155615604 - main/Render/CameraPhase.lua
	run(function()
		local CameraPhase
		local old
	...
	-- source: src/games/prison life/155615604 - main/Render/KillNotifications.lua
	run(function()
	...
	-- source: src/games/prison life/155615604 - main/Utility/AutoDetonate.lua
	run(function()
		local AutoDetonate
		local SafeCheck
		local localc4
	...
	-- source: src/games/prison life/155615604 - main/Utility/AutoReload.lua
	run(function()
		local AutoReload
		local HotSwap
	...
	-- source: src/games/prison life/155615604 - main/Utility/AutoToxic.lua
	run(function()
		local AutoToxic
	...
	-- source: src/games/prison life/155615604 - main/Utility/CheatDetector.lua
	run(function()
		local CheatDetector
		local AddTarget
	...
	-- source: src/games/prison life/155615604 - main/Utility/Disabler.lua
	run(function()
		local Disabler
		local old
