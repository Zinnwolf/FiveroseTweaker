return function(api)
	local run = function(func)
		...
		if not ok then
			...
			warn('[fiverosetweaker/arena] '..tostring(err))
		end
	...
	required(function()
		...
		if not (env and env.startHit) then
			repeat
				...
				task.wait()
			until env and env.startHit or vape.Loaded == nil or os.clock() >= timeout

			if vape.Loaded == nil then return end
			if not (env and env.startHit) then
				error('Arena character controller did not become ready within 30 seconds', 0)
			end
		end
	...
	for _, name in ipairs({'Client', 'PlayerState', 'Inventory', 'MoveController', 'SwingFunction', 'TickFunction', 'MoveFunction'}) do
		if arena[name] == nil then
			error('Arena bootstrap missing '..name, 0)
		end
	end
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/AutoBlock.lua
	run(function()
		local AutoBlock
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/Fly.lua
	run(function()
		run(function()
			local Keys
			local Value
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/HighJump.lua
	run(function()
		local HighJump
		local Value
		local AutoDisable
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/HitBoxes.lua
	run(function()
		local HitBoxes
		local Targets
		local TargetPart
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/Killaura.lua
	run(function()
		local Killaura
		local Targets
		local AttackRange
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/LongJump.lua
	run(function()
		local Value
		local AutoDisable
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/NoSlowdown.lua
	run(function()
		local NoSlowdown
		local old
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/Speed.lua
	run(function()
		local Speed
		local Value
		local AutoJump
	...
	-- source: src/games/1.8arena/77790193039862 - game/Blatant/Spider.lua
	run(function()
		local Value
	...
	-- source: src/games/1.8arena/77790193039862 - game/Combat/AutoClicker.lua
	run(function()
		local AutoClicker
		local CPS
		local Thread
	...
	-- source: src/games/1.8arena/77790193039862 - game/Combat/Reach.lua
	run(function()
		local Reach
		local Value
		local old
	...
	-- source: src/games/1.8arena/77790193039862 - game/Combat/Sprint.lua
	run(function()
		local Sprint
	...
	-- source: src/games/1.8arena/77790193039862 - game/Combat/Velocity.lua
	run(function()
		local Velocity
		local Horizontal
		local Vertical
	...
	-- source: src/games/1.8arena/77790193039862 - game/World/FastBreak.lua
	run(function()
		local FastBreak
		local Value
		local old
	...
	-- source: src/games/1.8arena/77790193039862 - game/World/FastPlace.lua
	run(function()
		local FastPlace
		local Value
		local old
