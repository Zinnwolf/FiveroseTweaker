return function(api)
	local run = function(func)
		...
		if not ok then
			...
			warn('[fiverosetweaker/blocktales] '..tostring(err))
		end
	...
	for _, name in ipairs({'Ambassador', 'BattleClient', 'Enemy', 'Network', 'Shucky', 'Variables'}) do
		if bt[name] == nil then
			error('Block Tales bootstrap missing '..name, 0)
		end
	end
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/AntiHazard.lua
	run(function()
		local AntiHazard
		local old
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/Fly.lua
	run(function()
		run(function()
			local Value
			local VerticalValue
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/FlyingAttack.lua
	run(function()
		local FlyingAttack
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/LongJump.lua
	run(function()
		local Value
		local AutoDisable
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/PickupTP.lua
	run(function()
		local PickupTP
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/Speed.lua
	run(function()
		local Speed
		local Value
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Blatant/SpeedSpin.lua
	run(function()
		local SpeedSpin
		local Value
		local old
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Combat/AutoAction.lua
	run(function()
		local AutoAction
		local Attack
		local Block
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Combat/MissCooldown.lua
	run(function()
		local MissCooldown
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Minigames/AutoCamel.lua
	run(function()
		local AutoCamel
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Minigames/AutoCloudGrind.lua
	run(function()
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Minigames/AutoFish.lua
	run(function()
		local AutoFish
		local KeepList
		local old
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Minigames/AutoPaint.lua
	run(function()
		local AutoPaint
	...
	-- source: src/games/blocktales/16483433878 - blocktales/Render/PickupTracers.lua
	run(function()
		local PickupTracers
		local Color
		local Transparency
